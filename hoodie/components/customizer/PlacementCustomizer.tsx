...
import {
  ...
  AVAILABLE_FONTS,
  PlacementArea,
} from "@/lib/store/useCustomizerStore";
...
export function PlacementCustomizer() {
    ...
    switch (activePlacement) {
      case "front":
        return {
          ...
          setPosition: (pos: Partial<{ x: number; y: number }>) =>
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      console.log(
        `[PlacementCustomizer] Uploading image for placement: ${activePlacement}`,
      );
      ...
      console.log(
        `[PlacementCustomizer] Upload successful, URL: ${response.url}`,
      );
  ...
  const handleRemoveBackground = async () => {
    ...
    try {
      ...
      console.log(
        `[PlacementCustomizer] Background removed image uploaded, URL: ${uploadResponse.url}`,
      );
      ...
      {data.text &&
        (activePlacement === "front" || activePlacement === "back") && (
          <div className="relative">
            ...
            >
              <span>
                {AVAILABLE_FONTS.find((f) => f.value === data.textFont)?.name ||
                  data.textFont}
              </span>
              <svg
                className={`w-4 h-4 transition-transform ${showFontDropdown ? "rotate-180" : ""}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    data.setPosition({ x: parseFloat(e.target.value) })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    data.setPosition({ y: parseFloat(e.target.value) })
                  }
                  className="w-full h-1.5 bg-neutral-200 rounded-lg appearance-none cursor-pointer accent-neutral-900"
                />
              </div>
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    data.setTextPosition({ x: parseFloat(e.target.value) })
                  }
                  className="w-full h-1.5 bg-neutral-200 rounded-lg appearance-none cursor-pointer accent-neutral-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    data.setTextPosition({ y: parseFloat(e.target.value) })
                  }
                  className="w-full h-1.5 bg-neutral-200 rounded-lg appearance-none cursor-pointer accent-neutral-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    data.setTextScale(parseFloat(e.target.value))
                  }
                  className="w-full h-1.5 bg-neutral-200 rounded-lg appearance-none cursor-pointer accent-neutral-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    data.setTextRotation(parseFloat(e.target.value))
                  }
                  className="w-full h-1.5 bg-neutral-200 rounded-lg appearance-none cursor-pointer accent-neutral-900"
                />
              </div>
